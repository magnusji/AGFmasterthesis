...
;file=' '
;read,file
file=dialog_pickfile(path='r:\meteor\NSMR\',filter='*.met')
;filenames=findfile('s:\ftproot\NSMR-ana\*.met',count=nfiles)
...
;for ifile=dfiles-1,nfiles-1 do begin    ;%%%%%%%%%%%%%%%%%%%%file read loop%%%%%%%%%%%%%%%%%%
